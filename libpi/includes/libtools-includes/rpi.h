...
//! this is now refined in rpi-asm.h
// enum {
//     SYSCALL_HELLO,
//     SYSCALL_PUTC
// };
...
//!ISSUE: I'm hardcoding in a buf size of 10024
#define SPRINTF_BUF_SIZE 100024
#define sprintf(buf, fmt, args...) (snprintk)(buf, SPRINTF_BUF_SIZE, fmt, ##args)
