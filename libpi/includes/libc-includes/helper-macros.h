...
#define PTR_ALIGN_DOWN(base, size) ((__typeof__ (base)) ALIGN_DOWN ((unsigned) (base), (size)))

/* Same as ALIGN_UP(), but automatically casts when base is a pointer.  */
#define PTR_ALIGN_UP(base, size) ((__typeof__ (base)) ALIGN_UP ((unsigned) (base), (size)))